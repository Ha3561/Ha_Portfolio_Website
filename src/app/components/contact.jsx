...
const Contact = () => {
  return (
    <div className='flex flex-col'> 
      ...
      <h2 className='my-20 text-center text-4xl'><span className='bg-gradient-to-r from-blue-400  to-purple-500 bg-clip-text tracking-tight text-transparent'>Contact</span></h2> 
      <br />
